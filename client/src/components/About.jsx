  ...
  useGSAP(() => {
    ...
    scrollTimeline
      ...
      .from(
        ...
        "-=0.5"
      ); // it wiil make the animation start half of the second before the previous one ends.So both animation overlap a bit which feels smoother and faster.
  });
      ...
      <div className="md-16 md:px-0 px-5">
        <div className="content">
          <div className="md:col-span-8">
            <p className="bedge">Best Cooktails</p>
            <h2>
